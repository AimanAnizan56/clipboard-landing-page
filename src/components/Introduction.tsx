...
const Introduction = () => {
  return (
    <>
      ...
      <h1 className="font-bold text-3xl text-center w-[85vw] mx-auto mb-4">A history of everything you copy</h1>

      <div className="font-bold text-center text-neutral-gray-blue w-[85vw] max-w-xl mx-auto mb-10">Clipboard allows you to track and organize everything you copy. Instantly access your clipboard on all your devices.</div>
