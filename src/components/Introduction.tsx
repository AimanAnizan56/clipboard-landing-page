...
const Introduction = () => {
  return (
    <>
      ...
      <div className="text-center text-neutral-gray-blue w-[85vw] max-w-xl mx-auto mb-10">Clipboard allows you to track and organize everything you copy. Instantly access your clipboard on all your devices.</div>
